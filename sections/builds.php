<div data-section-name="builds">
    <div class="section-header section-header-size">Setup</div>
            ...
            echo "<div class='build'>";
                ...
                echo "<div class='build-info'>
                        <div class='build-specs'>
                            <dl>
                                <dt class='dt-mod'><b>Processador:</b></dt>
                                    <dd>" . $proc . "</dd>";
                                if($cool != NULL) {
                                    echo "<dt class='dt-mod'><b>Refrigeramento:</b></dt>
                                        <dd>" . $cool . "</dd>";
                                }
                                echo "<dt class='dt-mod'><b>Placa Mãe:</b></dt>
                                    <dd>" . $mobo . "</dd>
                                <dt class='dt-mod'><b>Memória:</b></dt>
                                    <dd>" . $ram . "</dd>
                                ...
                                echo "<dt class='dt-mod'><b>Placa de Vídeo:</b></dt>
                                    <dd>" . $vid . "</dd>
                            </dl>
                        </div>
                        <div class='build-pic'>
